...
def create_simulation_from_inputs(input) -> Simulation:
    ...
    params = SimulationParameters(
        ...
        communication_recompute_interval=input.communication_recompute_interval(),
        communication_recompute_adaptive=input.communication_recompute_adaptive(),
        communication_recompute_min_interval=input.communication_recompute_min_interval(),
        communication_recompute_max_interval=input.communication_recompute_max_interval(),

        # --- Deterrence params ---
        deter_coeff=input.deter_coeff(),
        deter_threshold=input.deter_threshold(),

        # --- Sound propagation ---
        alpha_hat=input.alpha_hat(),
        beta_hat=input.beta_hat(),
    )
