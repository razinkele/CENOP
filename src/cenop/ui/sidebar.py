    ...
    return ui.sidebar(
        ...
        ui.div(
            ui.div(
                ui.tags.label(
                    ...
                    ui.tags.span(
                        "ⓘ",
                        title=SIDEBAR_TOOLTIPS["porpoise_count"],
            ...
            ui.div(
                ui.tags.label(
                    ...
                    ui.tags.span(
                        "ⓘ",
                        title=SIDEBAR_TOOLTIPS["sim_years"],
                        style="cursor: help; color: #0d7377;",
                    ),
                    **{"for": "sim_years"},
                ),
            ...
            ui.div(
                ui.tags.label(
                    ...
                    ui.tags.span(
                        "ⓘ",
                        title=SIDEBAR_TOOLTIPS["simulation_mode"],
                        style="cursor: help; color: #0d7377;",
                    ),
                    **{"for": "simulation_mode"},
                ),
            ...
            ui.div(
                ui.tags.label(
                    ...
                    ui.tags.span(
                        "ⓘ",
                        title=SIDEBAR_TOOLTIPS["landscape"],
                        style="cursor: help; color: #0d7377;",
                    ),
                    **{"for": "landscape"},
                ),
            ...
            ui.input_action_button(
                "load_landscape", "Load Landscape", class_="btn-outline-secondary w-100 mt-1 mb-1"
            ),
            ui.output_text("landscape_status"),
            # Turbine scenario - dynamically filtered based on landscape
            ui.output_ui("turbine_selector"),
            ui.input_action_button(
                "load_turbines", "Load Turbines", class_="btn-outline-secondary w-100 mt-1 mb-1"
            ),
        ...
        ui.div(
            ui.tags.label(
                "Simulation Speed ",
                ui.tags.span(
                    "ⓘ", title=SIDEBAR_TOOLTIPS["sim_speed"], style="cursor: help; color: #0d7377;"
                ),
            ),
            ui.input_slider("sim_speed", None, min=1, max=100, value=50, step=1, post=" %"),
            ui.p("1% = slowest, 100% = fastest", class_="text-muted small mb-0"),
            class_="mb-3",
        ),
        # Skip visualization for faster headless runs
        ui.div(
            ui.input_checkbox("skip_viz", "Skip visualization (fast run)", value=False),
            class_="mb-3",
        ),
        # Porpoise trace controls
        ui.div(
            ui.input_checkbox("show_traces", "Show porpoise traces", value=False),
        ...
        ui.accordion(
            ui.accordion_panel(
                ...
                ui.input_slider(
                    "social_weight", "Social Weight", min=0.0, max=1.0, value=0.3, step=0.05
                ),
            ),
        ...
        ui.tags.hr(),
        ui.p(
            "Advanced parameters in 'Model Settings' tab. JASMINE-specific settings available when JASMINE mode is selected.",
