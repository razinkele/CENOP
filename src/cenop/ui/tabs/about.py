    ...
    return ui.nav_panel(
        ...
        ui.layout_columns(
            ui.card(
                    ...
                    ui.layout_columns(
                        ui.div(
                            ui.h6("DEPONS Mode (Standard)"),
                             ...
                             ui.p("Designed for Environmental Impact Assessments (EIA) compatible with DEPONS 3.0 standards."),
                ...
                ui.p("Based on DEPONS 3.0 specifications", class_="small text-muted text-center"),
