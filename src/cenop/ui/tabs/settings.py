            ...
            ui.card(
                ...
                ui.div(
                    ui.tags.label(
                        ...
                        ui.tags.span(
                            "ⓘ",
                            title=TOOLTIPS["tracked_porpoise_count"],
                            style="cursor: help; color: #0d7377;",
                        ),
            ...
            ui.card(
                ...
                ui.panel_conditional(
                    ...
                    ui.div(
                        ...
                        ui.input_switch("weston_flux_percell", None, value=False),
                        class_="mb-3 ms-3",
                    ),
                ),
                ui.div(
            ...
            ui.layout_column_wrap(
                ui.div(
                    ui.tags.label(
                        "k - Inertia constant ",
                        ui.tags.span(
                            "ⓘ", title=TOOLTIPS["param_k"], style="cursor: help; color: #0d7377;"
                        ),
                        **{"for": "param_k"},
                    ),
                ...
                ui.div(
                    ui.tags.label(
                        "a0 - AutoReg for log₁₀(d/100) ",
                        ui.tags.span(
                            "ⓘ", title=TOOLTIPS["param_a0"], style="cursor: help; color: #0d7377;"
                        ),
                        **{"for": "param_a0"},
                    ),
                ...
                ui.div(
                    ui.tags.label(
                        "a1 - Water depth effect ",
                        ui.tags.span(
                            "ⓘ", title=TOOLTIPS["param_a1"], style="cursor: help; color: #0d7377;"
                        ),
                        **{"for": "param_a1"},
                    ),
                ...
                ui.div(
                    ui.tags.label(
                        "a2 - Salinity effect ",
                        ui.tags.span(
                            "ⓘ", title=TOOLTIPS["param_a2"], style="cursor: help; color: #0d7377;"
                        ),
                        **{"for": "param_a2"},
                    ),
                ...
                ui.div(
                    ui.tags.label(
                        "b0 - AutoReg for turning ",
                        ui.tags.span(
                            "ⓘ", title=TOOLTIPS["param_b0"], style="cursor: help; color: #0d7377;"
                        ),
                        **{"for": "param_b0"},
                    ),
                ...
                ui.div(
                    ui.tags.label(
                        "b1 - Depth on turning ",
                        ui.tags.span(
                            "ⓘ", title=TOOLTIPS["param_b1"], style="cursor: help; color: #0d7377;"
                        ),
                        **{"for": "param_b1"},
                    ),
                ...
                ui.div(
                    ui.tags.label(
                        "b2 - Salinity on turning ",
                        ui.tags.span(
                            "ⓘ", title=TOOLTIPS["param_b2"], style="cursor: help; color: #0d7377;"
                        ),
                        **{"for": "param_b2"},
                    ),
                ...
                ui.div(
                    ui.tags.label(
                        "b3 - Intercept ",
                        ui.tags.span(
                            "ⓘ", title=TOOLTIPS["param_b3"], style="cursor: help; color: #0d7377;"
                        ),
                        **{"for": "param_b3"},
                    ),
    ...
    return ui.nav_panel(
        ...
        ui.layout_columns(
            ui.card(
                ...
                ui.div(
                    ui.tags.label(
                        "Dispersal Type ",
                        ui.tags.span(
                            "ⓘ", title=TOOLTIPS["dispersal"], style="cursor: help; color: #0d7377;"
                        ),
                        **{"for": "dispersal"},
                    ),
                    ui.input_select(
                ...
                ui.div(
                    ui.tags.label(
                        "Days to Dispersal (tDisp) ",
                        ui.tags.span(
                            "ⓘ", title=TOOLTIPS["tdisp"], style="cursor: help; color: #0d7377;"
                        ),
                        **{"for": "tdisp"},
                    ),
            ...
            ui.card(
                ...
                ui.div(
                    ui.tags.label(
                        "PSM_log - Logistic increase ",
                        ui.tags.span(
                            "ⓘ", title=TOOLTIPS["psm_log"], style="cursor: help; color: #0d7377;"
                        ),
                        **{"for": "psm_log"},
                    ),
                ...
                ui.div(
                    ui.tags.label(
                        "PSM_dist - Preferred distance ",
                        ui.tags.span(
                            "ⓘ", title=TOOLTIPS["psm_dist"], style="cursor: help; color: #0d7377;"
                        ),
                        **{"for": "psm_dist"},
                    ),
                ...
                ui.div(
                    ui.tags.label(
                        "PSM_tol - Tolerance (km) ",
                        ui.tags.span(
                            "ⓘ", title=TOOLTIPS["psm_tol"], style="cursor: help; color: #0d7377;"
                        ),
                        **{"for": "psm_tol"},
                    ),
                ...
                ui.div(
                    ui.tags.label(
                        "PSM_angle - Max turn (deg) ",
                        ui.tags.span(
                            "ⓘ", title=TOOLTIPS["psm_angle"], style="cursor: help; color: #0d7377;"
                        ),
                        **{"for": "psm_angle"},
                    ),
    ...
    return ui.nav_panel(
        ...
        ui.card(
            ...
            ui.layout_column_wrap(
                ui.div(
                    ui.tags.label(
                        "rS - Satiation memory decay ",
                        ui.tags.span(
                            "ⓘ", title=TOOLTIPS["param_rS"], style="cursor: help; color: #0d7377;"
                        ),
                        **{"for": "param_rS"},
                    ),
                ...
                ui.div(
                    ui.tags.label(
                        "rR - Reference memory decay ",
                        ui.tags.span(
                            "ⓘ", title=TOOLTIPS["param_rR"], style="cursor: help; color: #0d7377;"
                        ),
                        **{"for": "param_rR"},
                    ),
                ...
                ui.div(
                    ui.tags.label(
                        "rU - Food replenishment rate ",
                        ui.tags.span(
                            "ⓘ", title=TOOLTIPS["param_rU"], style="cursor: help; color: #0d7377;"
                        ),
                        **{"for": "param_rU"},
                    ),
            ...
            ui.card(
                ...
                ui.div(
                    ui.tags.label(
                        ...
                        ui.tags.span(
                            "ⓘ",
                            title=TOOLTIPS["time_mode_override"],
                            style="cursor: help; color: #0d7377;",
                        ),
                ...
                ui.div(
                    ui.tags.label(
                        ...
                        ui.tags.span(
                            "ⓘ",
                            title=TOOLTIPS["movement_mode_override"],
                            style="cursor: help; color: #0d7377;",
                        ),
                ...
                ui.div(
                    ui.tags.label(
                        ...
                        ui.tags.span(
                            "ⓘ",
                            title=TOOLTIPS["fsm_mode_override"],
                            style="cursor: help; color: #0d7377;",
                        ),
                ...
                ui.div(
                    ui.tags.label(
                        ...
                        ui.tags.span(
                            "ⓘ",
                            title=TOOLTIPS["energy_mode_override"],
                            style="cursor: help; color: #0d7377;",
                        ),
                ...
                ui.div(
                    ui.tags.label(
                        ...
                        ui.tags.span(
                            "ⓘ",
                            title=TOOLTIPS["memory_mode_override"],
                            style="cursor: help; color: #0d7377;",
                        ),
            ...
            ui.card(
                ...
                ui.div(
                    ui.tags.label(
                        ...
                        ui.tags.span(
                            "ⓘ",
                            title=TOOLTIPS["jasmine_mass_kg"],
                            style="cursor: help; color: #0d7377;",
                        ),
                        **{"for": "jasmine_mass_kg"},
                    ),
                    ui.input_numeric(
                        "jasmine_mass_kg", None, value=50.0, min=10.0, max=100.0, step=1.0
                    ),
                    class_="mb-2",
                ),
                ui.div(
                    ui.tags.label(
                        ...
                        ui.tags.span(
                            "ⓘ",
                            title=TOOLTIPS["jasmine_drag_coeff"],
                            style="cursor: help; color: #0d7377;",
                        ),
                        **{"for": "jasmine_drag_coeff"},
                    ),
                    ui.input_numeric(
                        "jasmine_drag_coeff", None, value=0.01, min=0.001, max=0.1, step=0.001
                    ),
                    class_="mb-2",
                ),
                ui.div(
                    ui.tags.label(
                        ...
                        ui.tags.span(
                            "ⓘ",
                            title=TOOLTIPS["jasmine_max_thrust"],
                            style="cursor: help; color: #0d7377;",
                        ),
                        **{"for": "jasmine_max_thrust"},
                    ),
                    ui.input_numeric(
                        "jasmine_max_thrust", None, value=100.0, min=10.0, max=500.0, step=10.0
                    ),
                    class_="mb-2",
                ),
                ui.div(
                    ui.tags.label(
                        ...
                        ui.tags.span(
                            "ⓘ",
                            title=TOOLTIPS["jasmine_current_weight"],
                            style="cursor: help; color: #0d7377;",
                        ),
                        **{"for": "jasmine_current_weight"},
                    ),
                    ui.input_numeric(
                        "jasmine_current_weight", None, value=0.5, min=0.0, max=1.0, step=0.1
                    ),
                    class_="mb-2",
                ),
            ),
            ...
            ui.card(
                ...
                ui.div(
                    ui.tags.label(
                        ...
                        ui.tags.span(
                            "ⓘ",
                            title=TOOLTIPS["jasmine_bmr_scale"],
                            style="cursor: help; color: #0d7377;",
                        ),
                        **{"for": "jasmine_bmr_scale"},
                    ),
                    ui.input_numeric(
                        "jasmine_bmr_scale", None, value=1.0, min=0.5, max=2.0, step=0.1
                    ),
                    class_="mb-2",
                ),
                ui.div(
                    ui.tags.label(
                        "Activity Cost Multiplier ",
                        ui.tags.span(
                            "ⓘ",
                            title=TOOLTIPS["jasmine_activity_cost"],
                            style="cursor: help; color: #0d7377;",
                        ),
                        **{"for": "jasmine_activity_cost"},
                    ),
                    ui.input_numeric(
                        "jasmine_activity_cost", None, value=2.0, min=1.0, max=5.0, step=0.1
                    ),
                    class_="mb-2",
                ),
                ui.div(
                    ui.tags.label(
                        "Disturbance Cost Multiplier ",
                        ui.tags.span(
                            "ⓘ",
                            title=TOOLTIPS["jasmine_disturbance_cost"],
                            style="cursor: help; color: #0d7377;",
                        ),
                        **{"for": "jasmine_disturbance_cost"},
                    ),
                    ui.input_numeric(
                        "jasmine_disturbance_cost", None, value=1.5, min=1.0, max=3.0, step=0.1
                    ),
                    class_="mb-2",
                ),
            ),
            ...
            ui.card(
                ...
                ui.div(
                    ui.tags.label(
                        ...
                        ui.tags.span(
                            "ⓘ",
                            title=TOOLTIPS["jasmine_memory_decay_rate"],
                            style="cursor: help; color: #0d7377;",
                        ),
                        **{"for": "jasmine_memory_decay_rate"},
                    ),
                    ui.input_numeric(
                        "jasmine_memory_decay_rate",
                        None,
                        value=0.001,
                        min=0.0001,
                        max=0.01,
                ...
                ui.div(
                    ui.tags.label(
                        ...
                        ui.tags.span(
                            "ⓘ",
                            title=TOOLTIPS["jasmine_avoidance_strength"],
                            style="cursor: help; color: #0d7377;",
                        ),
                        **{"for": "jasmine_avoidance_strength"},
                    ),
                    ui.input_numeric(
                        "jasmine_avoidance_strength", None, value=0.8, min=0.0, max=1.0, step=0.1
                    ),
                    class_="mb-2",
                ),
                ui.div(
                    ui.tags.label(
                        "Avoidance Radius (cells) ",
                        ui.tags.span(
                            "ⓘ",
                            title=TOOLTIPS["jasmine_avoidance_radius"],
                            style="cursor: help; color: #0d7377;",
                        ),
                        **{"for": "jasmine_avoidance_radius"},
                    ),
                    ui.input_numeric(
                        "jasmine_avoidance_radius", None, value=20.0, min=5.0, max=50.0, step=1.0
                    ),
                    class_="mb-2",
                ),
            ),
