...
class TestBatchRunner:
    ...
    def test_batch_configuration_combinations(self):
        ...
        config = BatchConfiguration(
            ...
            variations={"porpoise_count": [50, 100], "turbines": ["off", "construction"]},
            replicates=2,
        )
    ...
    def test_batch_configuration_no_variations(self):
        ...
        config = BatchConfiguration(
            base_params={"sim_years": 1, "porpoise_count": 50}, variations={}, replicates=3
        )
    ...
    def test_batch_runner_short_simulation(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            config = BatchConfiguration(
                base_params={"sim_years": 1, "porpoise_count": 10, "landscape": "Homogeneous"},
                variations={},
                replicates=2,
                output_dir=tmpdir,
            )
    ...
    def test_batch_get_results_by_parameter(self):
        ...
        from cenop.core.batch_runner import BatchConfiguration, BatchResult, BatchRunner
...
class TestOutputWriter:
    ...
    def test_mortality_event_dataclass(self):
        ...
        event = MortalityEvent(
            tick=100, day=2, porpoise_id=5, age=10.5, energy=0.1, cause="starvation", x=50.0, y=75.0
        )
...
class TestHistogramCharts:
    ...
    def test_histogram_empty_data(self):
        ...
        result = create_histogram_chart(
            data=[], title="Empty", x_title="X", y_title="Y", x_range=(0, 10)  # Required parameter
        )
...
class TestIntegration:
    ...
    def test_batch_runner_with_output_writer(self):
        ...
        config = BatchConfiguration(
            base_params={"sim_years": 1, "porpoise_count": 10}, variations={}, replicates=1
        )

        output_config = OutputConfig(output_dir="output/test", population=True)
