...
class TestSimulationParameters:
    ...
    def test_custom_parameters(self):
        ...
        params = SimulationParameters(porpoise_count=1000, sim_years=10, landscape="Homogeneous")
...
class TestCellData:
    ...
    def test_homogeneous_landscape(self):
        ...
        landscape = create_homogeneous_landscape(width=100, height=100, depth=20.0, food_prob=0.5)
...
class TestDispersal:
    ...
    def test_no_dispersal(self):
        ...
        from cenop.behavior.dispersal import DispersalType, create_dispersal_behavior
...
class TestSimulation:
    ...
    def test_simulation_creation(self):
        ...
        params = SimulationParameters(porpoise_count=100, sim_years=1, landscape="Homogeneous")
